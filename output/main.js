...
var _user$project$MTUK_API$encodeSignedContent = function (signed) {
	return A2(
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'key',
					_1: _elm_lang$core$Json_Encode$string(signed.key)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'value',
						_1: _elm_lang$core$Json_Encode$string(signed.value)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'signature',
							_1: _elm_lang$core$Json_Encode$string(signed.signature)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$MTUK_API$sign = F2(
	function (passwd, content) {
		var payload = A2(
			_elm_lang$core$Basics_ops['++'],
			_billstclair$elm_sha256$Sha256$sha256(passwd),
			A2(
				_elm_lang$core$Basics_ops['++'],
				_billstclair$elm_sha256$Sha256$sha256(content.key),
				_billstclair$elm_sha256$Sha256$sha256(content.value)));
		var signature_ = _billstclair$elm_sha256$Sha256$sha256(payload);
		return {key: content.key, value: content.value, signature: signature_};
	});
var _user$project$MTUK_API$testServerURL = 'https://testserver.url/api/';
var _user$project$MTUK_API$readURL = A2(_elm_lang$core$Basics_ops['++'], _user$project$MTUK_API$testServerURL, 'read');
var _user$project$MTUK_API$updateURL = A2(_elm_lang$core$Basics_ops['++'], _user$project$MTUK_API$testServerURL, 'update');
var _user$project$MTUK_API$Content = F2(
	function (a, b) {
		return {key: a, value: b};
	});
var _user$project$MTUK_API$decodeContent = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$MTUK_API$Content,
...
var _user$project$MTUK_API$reqRead = function (key) {
	return _elm_lang$http$Http$request(
		{
			method: 'GET',
			headers: {ctor: '[]'},
			url: A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$MTUK_API$readURL,
				A2(_elm_lang$core$Basics_ops['++'], '?key=', key)),
			body: _elm_lang$http$Http$emptyBody,
			expect: _elm_lang$http$Http$expectJson(_user$project$MTUK_API$decodeContent),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		});
};
var _user$project$MTUK_API$reqUpdate = F2(
	function (passwd, content) {
		var signed = A2(_user$project$MTUK_API$sign, passwd, content);
		return _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {ctor: '[]'},
				url: _user$project$MTUK_API$updateURL,
				body: A2(
					_elm_lang$http$Http$stringBody,
					'application/json',
					_user$project$MTUK_API$encodeSignedContent(signed)),
				expect: _elm_lang$http$Http$expectJson(_user$project$MTUK_API$decodeContent),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$MTUK_API$SignedContent = F3(
	function (a, b, c) {
		return {key: a, value: b, signature: c};
	});
var _user$project$MTUK_API$UpdateFailure = function (a) {
	return {ctor: 'UpdateFailure', _0: a};
};
var _user$project$MTUK_API$UpdateSuccess = function (a) {
	return {ctor: 'UpdateSuccess', _0: a};
};
var _user$project$MTUK_API$failUpdate = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
		return _user$project$MTUK_API$UpdateSuccess(_p0._0);
	} else {
		return _user$project$MTUK_API$UpdateFailure(
			function () {
				var _p1 = _p0._0;
				switch (_p1.ctor) {
					case 'BadUrl':
						return A2(_elm_lang$core$Basics_ops['++'], 'BadUrl ', _p1._0);
					case 'Timeout':
						return 'Timeout';
					case 'NetworkError':
						return 'NetworkError';
...
var _user$project$MTUK_API$update = F2(
	function (passwd, content) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$MTUK_API$failUpdate,
			A2(_user$project$MTUK_API$reqUpdate, passwd, content));
	});
var _user$project$MTUK_API$ReadFailure = function (a) {
	return {ctor: 'ReadFailure', _0: a};
};
var _user$project$MTUK_API$ReadSuccess = function (a) {
	return {ctor: 'ReadSuccess', _0: a};
};
var _user$project$MTUK_API$failRead = function (result) {
	var _p2 = result;
	if (_p2.ctor === 'Ok') {
		return _user$project$MTUK_API$ReadSuccess(_p2._0);
	} else {
		return _user$project$MTUK_API$ReadFailure(
			function () {
				var _p3 = _p2._0;
				switch (_p3.ctor) {
					case 'BadUrl':
						return A2(_elm_lang$core$Basics_ops['++'], 'BadUrl ', _p3._0);
					case 'Timeout':
						return 'Timeout';
					case 'NetworkError':
						return 'NetworkError';
...
var _user$project$MTUK_API$read = function (key) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$MTUK_API$failRead,
		_user$project$MTUK_API$reqRead(key));
};
...
var _user$project$MTUK_ContentCard$ApiResponse = function (a) {
	return {ctor: 'ApiResponse', _0: a};
};
var _user$project$MTUK_ContentCard$ApiRequestLoad = {ctor: 'ApiRequestLoad'};
	...
	function (action, model) {
		...
		while (true) {
			...
			switch (_p0.ctor) {
						...
						switch (_p3.ctor) {
							...
							default:
								...
								return {
									...
									_1: A2(
										_elm_lang$core$Platform_Cmd$map,
										_user$project$MTUK_ContentCard$ApiResponse,
										A2(_user$project$MTUK_API$update, _p4.passwd, content_))
								};
						}
					}
				case 'ApiRequestLoad':
					return {
						...
						_1: A2(
							_elm_lang$core$Platform_Cmd$map,
							_user$project$MTUK_ContentCard$ApiResponse,
							_user$project$MTUK_API$read(model.key))
					};
				case 'ApiResponse':
					switch (_p0._0.ctor) {
						case 'ReadSuccess':
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										body: _elm_lang$core$Maybe$Just(_p0._0._0.value)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						case 'ReadFailure':
				...
				default:
					var _v4 = _user$project$MTUK_ContentCard$ApiRequestLoad,
						_v5 = model;
					action = _v4;
					model = _v5;
					continue update;
...
var _user$project$MTUK_SpeakerCard$speaker4 = {key: 'speaker4', icon: 'speaker4-icon', name: 'speaker4-name', blob: _elm_lang$core$Maybe$Nothing};
var _user$project$MTUK_SpeakerCard$speaker3 = {key: 'speaker3', icon: 'speaker3-icon', name: 'speaker3-name', blob: _elm_lang$core$Maybe$Nothing};
var _user$project$MTUK_SpeakerCard$speaker2 = {key: 'speaker2', icon: 'speaker2-icon', name: 'speaker2-name', blob: _elm_lang$core$Maybe$Nothing};
var _user$project$MTUK_SpeakerCard$speaker1 = {key: 'speaker1', icon: 'speaker1-icon', name: 'speaker1-name', blob: _elm_lang$core$Maybe$Nothing};
...
var _user$project$MTUK_SpeakerCard$ApiResponse = function (a) {
	return {ctor: 'ApiResponse', _0: a};
};
var _user$project$MTUK_SpeakerCard$ApiRequest = function (a) {
	return {ctor: 'ApiRequest', _0: a};
};
		...
		switch (_p1.ctor) {
			...
			case 'ApiRequest':
				return {
					...
					_1: A2(
						_elm_lang$core$Platform_Cmd$map,
						_user$project$MTUK_SpeakerCard$ApiResponse,
						_user$project$MTUK_API$read(_p1._0))
				};
			case 'ApiResponse':
				switch (_p1._0.ctor) {
					case 'ReadSuccess':
						var _p2 = _p1._0._0;
						var toggle = function (speaker) {
							return _elm_lang$core$Native_Utils.eq(speaker.key, _p2.key) ? _elm_lang$core$Native_Utils.update(
								speaker,
								{
									blob: _elm_lang$core$Maybe$Just(_p2.value)
								}) : speaker;
						};
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									speakers: A2(_elm_lang$core$List$map, toggle, model.speakers)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'ReadFailure':
			...
			default:
				var request = function (speaker) {
					return _user$project$MTUK_SpeakerCard$ApiRequest(speaker.key);
				};
				return A3(
					_user$project$MTUK_Util$batched,
					_user$project$MTUK_SpeakerCard$update,
					A2(_elm_lang$core$List$map, request, model.speakers),
					model);
		}
	});
var _user$project$MTUK_SpeakerCard$editBtn = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$onClick(
							_user$project$MTUK_SpeakerCard$ApiRequest('speaker1')),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$MTUK_ScheduleCard$ApiResponse = function (a) {
	return {ctor: 'ApiResponse', _0: a};
};
var _user$project$MTUK_ScheduleCard$ApiRequestLoad = {ctor: 'ApiRequestLoad'};
	...
	function (action, model) {
		...
		while (true) {
			...
			switch (_p0.ctor) {
						...
						switch (_p3.ctor) {
							...
							default:
								...
								return {
									...
									_1: A2(
										_elm_lang$core$Platform_Cmd$map,
										_user$project$MTUK_ScheduleCard$ApiResponse,
										A2(_user$project$MTUK_API$update, _p4.passwd, content_))
								};
						}
					}
				...
				default:
					var _v4 = _user$project$MTUK_ScheduleCard$ApiRequestLoad,
						_v5 = model;
					action = _v4;
					model = _v5;
					continue update;
